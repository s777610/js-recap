...
const empireState = new Building("Empire State Building", 102, "NY, NY");

console.log("empireState", empireState);

empireState.info();

const salesforceTower = new Building("Salesforce Tower", 61, "SF, CA");
...
console.log("salesforceTower.guests", salesforceTower.guests);
